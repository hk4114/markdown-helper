import{M as r}from"./index-Pr1v0e6f.js";import{_ as a}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{a as d,o as l,aO as p,aX as t,aZ as m,c as f,aQ as i,aN as s}from"./index-BbyNkpmY.js";const c="preview-only",g={__name:"index",setup(h){let o=d("");return l(()=>{const e=document.getElementById("textarea");o.value=e.value}),(e,n)=>(s(),p("div",null,[n[0]||(n[0]=t("h1",null,"markdown-here",-1)),n[1]||(n[1]=m(" 复制代码到 浏览器插件 markdown-here ")),n[2]||(n[2]=t("textarea",{id:"textarea",class:"textarea"},`## 得到
...
\`\`\`
      `,-1)),f(i(r),{editorId:c,modelValue:i(o)},null,8,["modelValue"])]))}},w=a(g,[["__scopeId","data-v-506ea4af"]]);export{w as default};
